...
export const addUniValidator = [
  check('universityName', 'University name is required.').isLength({min : 1}).withMessage('Name is required.'),
  check('website', 'Website is required.').isLength({min : 1}).withMessage('Website is required.').isURL(),
  check('email', 'Email is required.').isLength({min : 1}).withMessage('Email is required.'),
  check('about', 'Information about university is required.').isLength({min : 1}).withMessage('Information is required.'),
